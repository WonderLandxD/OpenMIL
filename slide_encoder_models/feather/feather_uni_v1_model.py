...
class FEATHER_UNIV1_Model(nn.Module):
    def __init__(self, model_id="MahmoodLab/abmil.base.uni.pc108-24k", num_classes=0, checkpoint_path=None, weights_filename=None, cache_dir=None):
        super().__init__()
        self.model_id = model_id
        print("WARNING: FEATHER_UNIV1 requires patch features extracted by UNI-1 (1024-dim). "
...
if __name__ == "__main__":
    model = FEATHER_UNIV1_Model(num_classes=2)
