...
class FEATHER_CONCH_V1_5_Model(nn.Module):
    def __init__(
        self,
        ...
        print(
            "WARNING: FEATHER_CONCH_V1_5 requires patch features extracted by CONCH v1.5 (768-dim). "
...
if __name__ == "__main__":
    model = FEATHER_CONCH_V1_5_Model(num_classes=2)
